<?php
  ...
  class Level extends Connection{
    ...
    public function update_level($id){
        ...
        $color = $this->real_escape($_POST['color']);
        $final_exam_grammer  = $this->real_escape($_POST['final_exam_grammer']);
        $final_exam_quran    = $this->real_escape($_POST['final_exam_quran']);
