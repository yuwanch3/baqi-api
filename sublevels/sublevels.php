<?php
  ...
  class Sublevels extends Connection{
    ...
    /*Get one*/
    public function get_sublevelId($var){
    ...
    /*Update*/
    public function update_sublevels($id){
        $id      = $this->real_escape($id);
        $name    = $this->real_escape($_POST['name']);
        $level   = $this->real_escape($_POST['level']);
        $ujian_grammer   = $this->real_escape($_POST['ujian_grammer']);
        $ujian_pelajaran = $this->real_escape($_POST['ujian_pelajaran']);
        $backgroundColor = $this->real_escape($_POST['backgroundColor']);
    ...
    /*Insert*/
    public function insert_sublevels(){
