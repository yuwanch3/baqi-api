      ...
      $status      = @$d['status'];
         ...
         switch ($request_method) {
            ...
            case 'POST':
                  if(!empty($_GET["id"])){
                     $id=$_GET["id"];
                     $skors->update_last($id, $uid, $mid, $lid, $sublid, $total, $excerpt, $correct, $wrong, $current, $status);  ///-------
                  }else{
                     $skors->insert_last($uid, $mid, $lid, $sublid, $total, $excerpt, $correct, $wrong, $current, $status);     ///-------
                  }     
                  break; 
